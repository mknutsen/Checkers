...
public class CheckersBoard {
     ...
     */
    public static final Coordinate getCell(final MouseEvent e) {
     ...
     */
    public final MovesList getRealMoves(CheckersPiece myPiece, MovesList availableMoves) {
     ...
     */
    private final void checkForJumps(int row, int col, boolean player1, MovesList moves,
    ...
    public final boolean makeMove(final CheckersPiece movingPiece, final Coordinate endCell) {
        ...
        if (getRealMoves(movingPiece, availableMoves).contains(endCell)) {
